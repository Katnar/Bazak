        ...
        <table id="table-to-xls">
          ...
          <tbody>
            {data.map((data, index) => {
              ...
              return (<tr>
                {props.unittype == 'admin' && data.pikod || props.unittype == 'general' && data.pikod ? <th style={{ width: `${100 / 3}%`, minWidth: '150px', position: 'sticky', top:'-2px' }}><Link style={{ textDecoration: 'none', color: 'inherit' }} to={`/subunitspage/pikod/${data.pikod._id}/${props.match.params.cartype}/${props.match.params.carid}`}>{data.pikod.name}</Link></th>
                  : props.unittype == 'pikod' && data.ogda ? <th style={{ width: `${100 / 3}%`, minWidth: '150px', position: 'sticky', top:'-2px' }}><Link style={{ textDecoration: 'none', color: 'inherit' }} to={`/subunitspage/ogda/${data.ogda._id}/${props.match.params.cartype}/${props.match.params.carid}`}>{data.ogda.name}</Link></th>
                    : props.unittype == 'ogda' && data.hativa ? <th style={{ width: `${100 / 3}%`, minWidth: '150px', position: 'sticky', top:'-2px' }}><Link style={{ textDecoration: 'none', color: 'inherit' }} to={`/subunitspage/hativa/${data.hativa._id}/${props.match.params.cartype}/${props.match.params.carid}`}>{data.hativa.name}</Link></th>
                      : props.unittype == 'hativa' && data.gdod ? <><th style={{ width: `${100 / 3}%`, minWidth: '150px', position: 'sticky', top:'-2px' }}><Link style={{ textDecoration: 'none', color: 'inherit' }} to={`/zminotpage/gdod/${data.gdod._id}/magadal/0/false`}>{data.gdod.name}</Link></th> <td>{data.maxdate.toISOString().slice(0, 10).split("-").reverse().join("/")}</td></>
