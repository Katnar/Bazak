...
const SubChartCard = (props) => {
	...
	function init() {
		...
		if (props.chart.tenetree && props.chart.tenetree != undefined) {
			...
			temp = temp.concat(
				temp_cardata_by_chart.filter((cardata) => cardata[lastKey] == lastValue)
			);
				...
				<CardHeader style={{ padding: "0px" }}>
					<div style={{ textAlign: "right" }}>
						{props.theme == "white-content" ? (
							Object.keys(props.chart.tenetree).pop() == "magadal" ? (
								<>
									<Link
										...
										to={`/modularchartpage/${
											...
											props.chart.tenetree[
												Object.keys(props.chart.tenetree).pop()
											]
										}`}
									>
										<img
							...
							) : Object.keys(props.chart.tenetree).pop() == "magad" ? (
								<>
									<Link
										style={{ textDecoration: "none", color: "inherit" }}
										to={`/modularchartpage/${
							...
							) : Object.keys(props.chart.tenetree).pop() == "mkabaz" ? (
								<>
									<Link
										style={{ textDecoration: "none", color: "inherit" }}
										to={`/modularchartpage/${
							...
							<>
								<Link
									style={{ textDecoration: "none", color: "inherit" }}
									to={`/modularchartpage/${props.match.params.chartid}/magad/${
										props.chart.tenetree[
											Object.keys(props.chart.tenetree).pop()
										]
									}`}
							...
							<>
								<Link
									style={{ textDecoration: "none", color: "inherit" }}
									to={`/modularchartpage/${props.match.params.chartid}/mkabaz/${
										props.chart.tenetree[
											Object.keys(props.chart.tenetree).pop()
										]
									}`}
							...
							<>
								<Link
									style={{ textDecoration: "none", color: "inherit" }}
									to={`/modularchartpage/${props.match.params.chartid}/makat/${
										props.chart.tenetree[
											Object.keys(props.chart.tenetree).pop()
										]
									}`}
